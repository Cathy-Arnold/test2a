...
describe('Partial Refund for an Umbraco order', () => {
  ...
  it('Partial Refund for an Umbraco order', () => {
    const orderNumber = "F417072D-F08E1B-25C6D"
...
//                 assert.refundTable(refundTableFile, totalRefundAmount, refundedTax, totalRefundAmountRequested, refundShippingAmount, messageText, totalRefundAmount)
//               })
//             })
//           })
//         })
...
cy.get('@orderNumber').then(orderNumber => {
  const feeQuery = ("Select sof.amt "
    ...
    + "Where so.OrderNumber = 'F417072D-F08E1B-25C6D' "
